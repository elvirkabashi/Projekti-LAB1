...
export const Loans = () => {
    ...
    const [httpError, setHtttprror] = useState(null);
    ...
    return (
        ...
        <div className="d-none d-lg-block mt-2">
            ...
            {shelfCurrentLoans.length > 0 ?
                ...
                <Link className='btn btn-primary' to={`search`}>Search for e new book</Link>
                </>
        ...
        <div className="container d-lg-none mt-2">
            ...
            {shelfCurrentLoans.length > 0 ?
                <>
                    ...
                    {shelfCurrentLoans.map(shelfCurrentLoan => (
                        <div key={shelfCurrentLoan.book.id}>
                                <div className="d-flex justify-content-center align-tiems-center">
                                    {shelfCurrentLoan.book?.img ?
                                        <img src={shelfCurrentLoan.book?.img} width='226' height='349' alt='Book'/>
                                        :
                                        <img src={require('./../../../Images/BooksImages/book-luv2code-1000.png')} width='226' height='349' alt='Book'/>
